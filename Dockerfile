...
RUN apt-get update && apt-get -qqy install wget curl make git-core php5 mysql-client-5.5 php5-mysqlnd php5-mcrypt php5-tidy php5-curl php5-gd nodejs npm && apt-get clean && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/*
